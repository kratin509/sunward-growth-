          ...
          >
            ...
            >
              ...
              <a
                ...
                className="mt-auto pt-3 inline-flex items-center gap-2 font-sans text-[11px] font-bold uppercase tracking-[0.16em] transition-colors duration-200"
                style={{ color: '#0077B5' }}
            ...
            <div className="max-w-[1440px] mx-auto">
              ...
              <div className="flex flex-col items-center gap-3 mb-12 text-center">
                ...
                <p
                  ...
                  style={{ fontSize: 'clamp(1.8rem, 4vw, 3.8rem)', color: '#FFFFFF', textShadow: '0 1px 24px rgba(255,255,255,0.18)' }}
                >
